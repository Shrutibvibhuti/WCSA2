...
public class FindElementsmethod {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.name("q")).sendKeys("bike");//for search box and type bike
		Thread.sleep(3000);
		
		List<WebElement> webElementSuggessions = driver.findElements(By.xpath("//div[@class='wM6W7d']/span"));  //xpath of first suggestion
